...
这里存放可沉淀到 Codex/Agent 的 AI 猎头工作流 skill。它们来自真实的 CANDYSIGN 推荐任务，覆盖招聘内容解析、飞书邮箱候选人筛选、每日邮箱入库、地域过滤、附件整理和推荐邮件草稿生成。
...
- [daily-mail-ingestion](daily-mail-ingestion/SKILL.md)：调用项目 CLI 每日读取飞书邮箱，把新客户、职位和候选人分类入库。
